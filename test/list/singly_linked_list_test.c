...
static int test_initialization()
{
    ...
    SinglyLinkedListConstruct(&list);
...
void singly_linked_list_setup()
{
    TEST_SUITE({

        TEST_CASE("Singly-Linked List Initialization", &test_initialization);
        TEST_CASE("Singly-Linked List Add", &test_add);
        TEST_CASE("Singly-Linked List Remove", &test_remove);
        TEST_CASE("Singly-Linked List Get Set", &test_get_set);
    });
}