...
struct doubly_linked_list
{
    ...
    void (*set) (struct doubly_linked_list *list, int index, void *value);
    void * (*get) (struct doubly_linked_list *list, int index);

    void (*add) (struct doubly_linked_list *list, int index, void *value);
    void (*addFirst) (struct doubly_linked_list *list, void *value);
    void (*addLast) (struct doubly_linked_list *list, void *value);

    void * (*remove) (struct doubly_linked_list *list, int index);
